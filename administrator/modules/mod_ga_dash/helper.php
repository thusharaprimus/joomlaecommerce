...
class modGoogleAnalyticsDashboardHelper
{
    ...
    public static function ga_generate_code( $params ){
		...
		switch ($gaperiod){
			...
			case '7daysAgo'	:	$from = '7daysAgo';
									$to = 'yesterday';
									$showevery = 3;
									break;	

			case '14daysAgo'	:	$from = '14daysAgo';
									$to = 'yesterday';
									$showevery = 4;
									break;	
								
			default	:	$from = '30daysAgo';
						$to = 'yesterday';
						$showevery = 6;
						break;
	...
	<div id="ga-dash">
		...
		<div id="gadash_div" style="height:350px;"></div>
			...
			<td width="12%" class="gavalue"><a href="?gaquery=visits&gaperiod='.$gaperiod.'" class="gatable">'.$data['rows'][0][1].'</td>
			<td width="24%">'.JText::_('GAD_VISITORS').':</td>
			<td width="12%" class="gavalue"><a href="?gaquery=visitors&gaperiod='.$gaperiod.'" class="gatable">'.$data['rows'][0][2].'</a></td>
