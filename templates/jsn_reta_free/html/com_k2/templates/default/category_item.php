	...
	<?php if($this->item->params->get('catItemImage') && !empty($this->item->image)|| $this->item->params->get('catItemDateCreated')): ?>
		...
		<div class="catItemImageBlock"> 
			...
			<div class="catItemHeader">
				...
				<?php endif; ?>
				<?php if($this->item->params->get('catItemAuthor') || $this->params->get('catFeedIcon')): ?>
				<div class="jsn-article-toolbar">
					<?php if($this->params->get('catFeedIcon')): ?>
					<!-- RSS feed icon -->
					<div class="catItemToolbar">
						<div class="k2FeedIcon"> <a href="<?php echo $this->feed; ?>" title="<?php echo JText::_('K2_SUBSCRIBE_TO_THIS_RSS_FEED'); ?>"> <i class="fa fa-rss"></i><span><?php echo JText::_('K2_SUBSCRIBE_TO_THIS_RSS_FEED'); ?></span> </a> </div>
					</div>
					<?php endif; ?>
					<div class="jsn-article-info">
						...
						<div class="catItemCategory"><i class="fa fa-folder-open-o"></i><a href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a> </div>
						<?php endif; ?>
