							...
							<div class="btn-group pull-right"> 
								...
								<ul class="dropdown-menu">
									<?php if ($params->get('show_print_icon')) : ?>
										<li><i class="fa fa-print"></i><?php echo JHtml::_('icon.print_popup', $this->item, $params); ?> </li>
									<?php endif; ?>
									<?php if ($params->get('show_email_icon')) : ?>
										<li> <i class="fa fa-envelope"></i> <?php echo JHtml::_('icon.email', $this->item, $params); ?> </li>
									<?php endif; ?>
									<?php if ($canEdit) : ?>
										<li><i class="fa fa-pencil"></i> <?php echo JHtml::_('icon.edit', $this->item, $params); ?> </li>
									<?php endif; ?>
								</ul>
							</div>
						<?php endif; ?>
		...
		<div class="article">
			...
			<?php if ($params->get('show_title')) : ?>
				...
				<?php if ($params->get('access-view')):?>
					...
					<?php endif; ?>
					<div class="jsn-article-text"><?php echo $this->item->text; ?></div>
					<?php 
