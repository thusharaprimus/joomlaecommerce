...
<?php if($this->countModules('fullwidth1')) : ?>
<div class="fullwidth">
<jdoc:include type="modules" name="fullwidth1" style="none" />
</div>
<?php endif; ?>
...
<div class="column-1">
<jdoc:include type="modules" name="bottom6" style="tagmodule" />
</div>
<?php endif; ?>
<?php if($this->countModules('bottom7')) : ?>
<div class="column-2">
<jdoc:include type="modules" name="bottom7" style="tagmodule" />
</div>
<?php endif; ?>
<?php if($this->countModules('bottom8')) : ?>
<div class="column-3">
<jdoc:include type="modules" name="bottom8" style="tagmodule" />
</div>
<?php endif; ?>
<?php if($this->countModules('bottom9')) : ?>
<div class="column-4">
<jdoc:include type="modules" name="bottom9" style="tagmodule" />
</div>
<?php endif; ?>
<?php if($this->countModules('bottom10')) : ?>
<div class="column-5">
<jdoc:include type="modules" name="bottom10" style="tagmodule" />
</div>
<?php endif; ?>
</div>
</div>
<?php endif; ?>
<?php if($this->countModules('fullwidth2')) : ?>
<div class="map">
<jdoc:include type="modules" name="fullwidth2" style="none" />
</div>
<?php endif; ?>
...
<div class="footer">
<div class="container cols-<?php echo $countblock6; ?>">
...
<?php endif; ?>
<script type="text/javascript" src="<?php echo $this->baseurl ?>/templates/<?php echo $this->template;?>/js/affix.js"></script>
</body>
</html>