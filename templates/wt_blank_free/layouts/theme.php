	...
	<div class="tm-page">
		<div class="uk-container uk-container-center">
			...
			<?php if ($this['widgets']->count('top-a')) : ?>
				<div id="tm-top-a" class="tm-block <?php echo $block_classes['top-a']; ?>">
			...
			<?php if ($this['widgets']->count('top-b')) : ?>
				<div id="tm-top-b" class="tm-block <?php echo $block_classes['top-b']; ?>">
			...
			<?php if ($this['widgets']->count('top-c')) : ?>
				<div id="tm-top-c" class="tm-block <?php echo $block_classes['top-c']; ?>">
			...
			<?php if ($this['widgets']->count('main-top + main-bottom + sidebar-a + sidebar-b') || $this['config']->get('system_output', true)) : ?>
				<div id="tm-main" class="tm-block <?php echo $block_classes['main']; ?>">
			...
			<?php if ($this['widgets']->count('bottom-a')) : ?>
				<div id="tm-bottom-a" class="tm-block <?php echo $block_classes['bottom-a']; ?>">
			...
			<?php if ($this['widgets']->count('bottom-b')) : ?>
				<div id="tm-bottom-b" class="tm-block <?php echo $block_classes['bottom-b']; ?>">
			...
			<?php if ($this['widgets']->count('bottom-c')) : ?>
				<div id="tm-bottom-c" class="tm-block <?php echo $block_classes['bottom-c']; ?>">
